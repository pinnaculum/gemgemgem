...
TextField {
  ...
  property var modifiers: ({ 0x02000000: "Shift", 0x04000000: "Ctrl",
    0x08000000: "Alt", 0x10000000: "Meta", 0x20000000: "Keypad",
    0x40000000: "GroupSwitch" })

  property var modifierKeys: [
    Qt.Key_Alt, Qt.Key_Meta, Qt.Key_Control,
    Qt.Key_Shift, Qt.Key_NumLock, Qt.Key_Mode_switch
  ]
  ...
  Keys.onReturnPressed: {
    focus = false
    currentShortcut = text
    modified(currentShortcut)
  }
}
